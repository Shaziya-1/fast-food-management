...
namespace FastFood_management1
{
    public partial class Form1 : Form
    {
        ...
        private void addBtn_Click(object sender, EventArgs e)
        {
            ...
            receiptTextbox.AppendText("\t\t\t\tTanha's Fast Food" + Environment.NewLine);
            receiptTextbox.AppendText("\t\t\t\t*****************" + Environment.NewLine);
            ...
            if (friesCheck.Checked == true)
            {
                ...
                subTotallbl.Text ="" + Convert.ToString(subtotal) + " taka/-";
            }
            ...
            tax = subtotal * 0.10;
            total = subtotal + tax;
            vatlbl.Text = Convert.ToString(tax) + " taka/-";
            totallbl.Text = Convert.ToString(total) + " taka/-";
            receiptTextbox.AppendText(Environment.NewLine);
            receiptTextbox.AppendText(Environment.NewLine);
